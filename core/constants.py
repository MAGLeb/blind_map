...
WAVE_HEIGHT_MM = 1.2  # Высота волн на воде (синусоидальные гребни) - снижена на 20%
WAVE_INTERVAL_MM = 8.0  # Интервал между гребнями волн - уменьшен для большего количества волн
WAVE_WIDTH_MM = 4.0  # Ширина линии волны - увеличена еще больше для лучшего тактильного ощущения
WAVE_SEGMENT_LENGTH_MM = 10.0  # Длина сегментов волн - максимум 1см
